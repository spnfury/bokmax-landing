    ...
    <section className="download-cta" id="download">
      <div className="container">
        <h2 className="download-cta-title">
          ...
          <span style={{ color: '#ffffff', fontWeight: '900' }}>Barbershop Experience?</span>
        </h2>
        ...
        <div className="download-cta-badges">
          <a href="#" className="store-badge btn-premium" style={{padding: '12px 24px', gap: '12px'}} id="dl-appstore">
          ...
          <a href="#" className="store-badge btn-premium" style={{padding: '12px 24px', gap: '12px'}} id="dl-playstore">
            <svg className="store-badge-icon" viewBox="0 0 24 24" fill="white">
